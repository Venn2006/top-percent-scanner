...
export default function FooterNav() {
  ...
  return (
    ...
    >
      ...
      <div className="grid w-full min-w-0 grid-cols-[minmax(0,1fr)_3.25rem] items-stretch gap-1.5 sm:contents">
        <Link
          href="/roadmap?new=1"
          onClick={tap}
        ...
        <SoundToggle
          className={`h-11 w-[3.25rem] max-w-full sm:order-last sm:h-12 sm:w-14 ${CHIP_BASE}`}
        />
      </div>
